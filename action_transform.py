...
class JSREPATransform(MultiViewTransform):
    ...
    def __init__(
        ...
        weak_transform = T.Compose([
                    T.RandomResizedCrop(global_crop_size, scale=weak_crop_scale),
        ...
        if n_global_views == 0:
            ...
            transforms = [global_transform_0, global_transform_1]*2
        elif n_global_views == 6:
            transforms = [global_transform_0, global_transform_1]*3
