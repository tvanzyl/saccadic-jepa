...
METHODS = {
    ...
    "Cifar100-weak-2":{"model": SimPLR.SimPLR, "n_local_views":0,
                     "train_transform": SimPLR.train_transforms["Cifar100"],  
                     "val_transform": SimPLR.val_transforms["Cifar100"], 
                     "transform": SimPLR.transforms["Cifar100-weak-2"],},
    "Cifar100-weak-4":{"model": SimPLR.SimPLR, "n_local_views":0,
                     "train_transform": SimPLR.train_transforms["Cifar100"],  
                     "val_transform": SimPLR.val_transforms["Cifar100"], 
                     "transform": SimPLR.transforms["Cifar100-weak-4"],},
    "Cifar100-4":   {"model": SimPLR.SimPLR, "n_local_views":2,
                     "train_transform": SimPLR.train_transforms["Cifar100"],  
                     "val_transform": SimPLR.val_transforms["Cifar100"], 
                     "transform": SimPLR.transforms["Cifar100-4"],},
    "Cifar100-6":   {"model": SimPLR.SimPLR, "n_local_views":4,
                     "train_transform": SimPLR.train_transforms["Cifar100"],  
                     "val_transform": SimPLR.val_transforms["Cifar100"], 
                     "transform": SimPLR.transforms["Cifar100-6"],},
    "Cifar100-12":  {"model": SimPLR.SimPLR, "n_local_views":10,
                     "train_transform": SimPLR.train_transforms["Cifar100"],  
                     "val_transform": SimPLR.val_transforms["Cifar100"], 
